...
// UTILS
export const getData = async templateUrl => {
...
// STATE -- to keep track the data (jobItem)
export const state = {
    searchJobItems: [],   // the data of job with object
    currentPage: 1,      // keep track the current page
    activeJobItem: {},
    bookmarkJobItems: []
}